...
export default function CL() {
  return (
    <main
      className={`${style.cl} flex flex-col lg:flex-row w-full h-full px-8 pt-0 pb-8 lg:px-16 lg:pt-0 lg:pb-16 gap-8 lg:gap-16 items-center justify-center`}
    >
...
function Collaborate({ title, description, href }) {
  return (
